    ...
    <div className="min-h-screen relative flex flex-col justify-center overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center flex-1 px-6 text-center">
        ...
        <button 
          ...
          className="bg-primary text-white rounded-pill px-8 py-4 text-lg font-heading font-semibold shimmer-btn shadow-glow-primary hover:scale-105 transition-all duration-300"
        >
          Get My Report →
        </button>

        <div className="flex flex-wrap justify-center gap-4 mt-12 w-full max-w-3xl">
          <div className="glass-card px-6 py-4 text-center animate-float flex-1 min-w-[200px]" style={{ animationDelay: '0s' }}>
            <div className="text-secondary font-bold text-2xl md:text-3xl mb-1">2.4M+</div>
            <div className="text-on-background/50 text-sm">Reports Generated</div>
          </div>
          <div className="glass-card px-6 py-4 text-center animate-float flex-1 min-w-[200px]" style={{ animationDelay: '0.5s' }}>
          ...
          <div className="glass-card px-6 py-4 text-center animate-float flex-1 min-w-[200px]" style={{ animationDelay: '1s' }}>
            <div className="text-primary font-bold text-xl md:text-2xl mb-1">Claude AI</div>
